...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><section id="artist<?php echo ($vo["id"]); ?>">
	...
	<div class="fuckpng">
		<img src="/quanquan/Public/<?php echo ($vo["artist_first_image_url"]); ?>" /> <img
			src="/quanquan/Public/<?php echo ($vo["artist_second_image_url"]); ?>" /> <img
			src="/quanquan/Public/<?php echo ($vo["artist_third_image_url"]); ?>" />
	</div>
	</div>
