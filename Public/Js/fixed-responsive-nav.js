(function () {
  ...
  if ("querySelector" in document && "addEventListener" in window) {
    ...
    window.addEventListener("scroll", function () {
      ...
      //菜单滑动
      //document.getElementById("getheight").style.height = "100px";
      //document.getElementById("hdr").style.top =  (-document.documentElement.scrollTop/48).toString()+"px";
      //if(document.documentElement.scrollTop == 0.toString() + "px") document.getElementById("hdr").style.top = 50.toString() + "px";
      //alert( document.getElementById("hdr").style.top);
